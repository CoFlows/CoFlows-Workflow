...
This tutorial explains how to create a simple API with [**CoFlows CE (Community Edition)**](https://github.com/QuantApp/CoFlows-CE). First you must install a [**git**](https://git-scm.com/downloads/guis/) client and [docker](https://www.docker.com/get-started) support for linux containers.
